...
class recipes{
protected:
    QVector<string>* names = new QVector<string>;
    QVector<string>* descriptions = new QVector<string>;
    QVector<string>* ingredients = new QVector<string>;
    QVector<string>* cookingSteps = new QVector<string>;
    QVector<int>* calories = new QVector<int>;
    QVector<bool> vegan;
...
public:
    recipes() {
      names->append("Vegan Stir-Fry");
      descriptions->append("A delicious stir-fry with vegetables and rice.");
      ingredients->append("mixed vegetables, rice, soy sauce");
      cookingSteps->append("1. Cook rice according to package instructions.\n2. Stir-fry mixed vegetables in a pan.\n3. Add soy sauce and stir until everything is cooked through.\n4. Serve hot with rice.");
      calories->append(300);
      vegan.append(true);
